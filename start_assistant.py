...
def chat_with_meeting_minutes_assistant(model_id,message):
    ...
    chatInput.agentId = ctypes.c_int(0)
    chatInput.modelId = ctypes.c_int(mid)
...
if __name__ == '__main__':
    ...
    #     "f4e8fa12b9143d8337c80a6db8bbc440.3Gs8fMATdRD6Vz0u"
    # )
    #流式输出回调
    ...
    chat_result = chat_with_pc_assistant(mid,"帮我把系统静音",[],stream_print)
    print(chat_result)
    # chat_weekly_result = chat_with_weekly_assistant(mid, "周一入职，周二对接之前离职人的项目，周三开始熟悉代码，周四将项目跑起来了了，周五摸鱼了一天", [], stream_print)
    # print(chat_weekly_result)
